...
/**
 * Функция изменения окончания слова рубль, в зависимости от суммы
 */
function wordDeclension() {
    const rub = parseInt(prompt('Введите количество рублей, которое хотите положить в банк:'));
    ...
    if (rub % 100 >= 5 && rub % 100 <= 20) {
        console.log(`Ваша сумма в ${rub} рублей успешно зачислена.`);
    } else if (rub % 10 === 1) {
        console.log(`Ваша сумма в ${rub} рубль успешно зачислена.`);
    } else if (rub % 10 >= 2 && rub % 10 <= 4) {
        console.log(`Ваша сумма в ${rub} рубля успешно зачислена.`);
    } else {
        console.log(`Ваша сумма в ${rub} рублей успешно зачислена.`);
    }
}
